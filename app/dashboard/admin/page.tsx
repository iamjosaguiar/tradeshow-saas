          ...
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white shadow-2xl border-0">
            ...
            <CardContent className="pt-6">
              <form onSubmit={handleCreateTradeshow} className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">Assign Sales Reps</label>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Select which sales reps can access this tradeshow. {selectedReps.length} rep{selectedReps.length !== 1 ? "s" : ""} selected.
                  </p>
                </div>
