...
export default function TradeShowLeadForm() {
  ...
  useEffect(() => {
    fetch("/api/track-view", {
      ...
      body: JSON.stringify({ formSource: "aa-tradeshow-lead" }),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      track("trade_show_lead_form_submission", {
        ...
        hasCurrentRespirator: !!formData.currentRespirator,
      })
  ...
  const successMessage = "Thank you! Your submission has been received successfully."
